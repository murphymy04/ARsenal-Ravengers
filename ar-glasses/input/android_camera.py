"""Android camera input via scrcpy + ffmpeg, streamed through a named pipe.

On Windows a named pipe (\\.\pipe\ar_camera) bridges scrcpy and ffmpeg so
no data ever touches disk.  On Linux/macOS a POSIX FIFO is used instead.
